...
class EmailTransferResponseModel extends BaseResponseModel implements iBarionModel
{
    public $IsTransferSuccessful;
    ...
    public function fromJson($json)
    {
        if (!empty($json)) {
            ...
            $this->IsTransferSuccessful = BarionHelper::jget($json, 'IsTransferSuccessful');
        }
    }
}
